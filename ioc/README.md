...
* Create a 'getBean(Class clazz)' method that returns the object of the class from the Map.
  * Throw a BeanNotFoundException if there is no object of the class in the Map. (You need to create the exception.)
